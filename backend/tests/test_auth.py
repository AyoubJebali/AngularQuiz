...
class TestAuthRoutes:
    ...
    def test_register_duplicate_username(self, client):
        ...
        response = client.post(
            "/register", json={"username": "testuser", "password": "differentpass"}
        )
    ...
    def test_login_invalid_credentials(self, client):
        ...
        response = client.post(
            "/login", json={"username": "nonexistent", "password": "wrongpass"}
        )
    ...
    def test_login_wrong_password(self, client):
        ...
        # Register user
        client.post(
            "/register", json={"username": "testuser", "password": "correctpass"}
        )
